...
<title>Nexflix Manager List</title>
    <style>
        *{box-sizing: border-box;}
        ...
        .search_row>div{float: left; height: 50px;}
        ...
        .search1{width: 20%; border: 1px solid black; line-height: 45px;}
        .search2{width: 60%; border: 1px solid black;}
        .search3{width: 20%; border: 1px solid black;}
    ...
    <form action="search.NetflixManager">
        <div class="container">
			...
			<div class="search_row">
					<div class="search1">영화 검색</div>
					<div class="search2">
						<input type="text" name="search" placeholder="Input title to search">
					</div>
					<div class="search3"><button>Movie Search</button></div>
			</div>
            <div class="content">
            ...
            <div class="btnContainer">
				<div>
					<a href="index.jsp"><button type="button">Movie Main</button></a>
				</div>
				<div>
					<button type="button" onclick="history.back()">Back</button>
				</div>
				<div>
					<a href="netflixupdate.jsp"><button type="button">Movie Update</button></a>
				</div>
				<div>
					<a href="netflixdelete.jsp"><button type="button">Movie Delete</button></a>
				</div>
			</div>
