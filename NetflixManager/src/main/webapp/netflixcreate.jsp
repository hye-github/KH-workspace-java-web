...
<head>
<meta charset="UTF-8">
<title>Nexflix Manager Insert</title>
    <style>
...
<body>
	<form action="create.NetflixManager">
		<div class="container">
			<div class="header">
				...
				<div class="row">
					...
					<div class="inputcontent">
						<input type="text" name="title"
							placeholder="Input title to insert">
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="inputcontent">
						<input type="text" name="genre"
							placeholder="Input genre to insert">
					</div>
				</div>
