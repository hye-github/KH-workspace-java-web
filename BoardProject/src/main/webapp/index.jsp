	...
	<c:choose>
		<c:when test="${loginID != null}">
			...
			<div class="container border bg-light">
				<form id="frm" action="/memberout.mem" method="post">
					...
					<div class="row mb-3 title">
						<div class="btn">
							...
							<button type="button" class="btn btn-primary" id="memberout">회원탈퇴</button>
						</div>
					</div>
				</form>
			</div>
		...
		<c:otherwise>
			<div class="container border bg-light">
				<form class="px-4 py-3" action="/signin.mem" method="post">
					<div class="mb-3 center">
						<h1>Login Box</h1>
					</div>
					<div class="row mb-3 title">
					...
					<div class="center">
						...
						<a href="/member/signup.jsp"><button type="button"
